...
def convert_torch2transformers(torch_path, transformers_path, lm_config, dtype=torch.bfloat16):
    ...
    PigCPMOmni.register_for_auto_class("AutoModelForCausalLM")
    model = PigCPMOmni(lm_config, audio_encoder_path="../model/SenseVoiceSmall", vision_model_path="../model/siglip2-base-p32-256-ve")
