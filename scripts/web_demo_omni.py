...
from model.model_omni import PigCPMOmni, OmniConfig
...
def load_hf_model(model_path):
    ...
    with model_lock:
        ...
        vision_encoder, vision_processor = PigCPMOmni.load_vision(args.vision_model)
        audio_encoder, audio_processor = PigCPMOmni.load_sensevoice(args.audio_encoder)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="PigCPM-O Gradio Demo")
