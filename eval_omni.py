...
def init_model(args):
    ...
    if 'model' in args.load_from:
        ...
        model.audio_encoder, model.audio_processor = PigCPMOmni.load_sensevoice("./model/SenseVoiceSmall")
        model.vision_encoder, model.vision_processor = PigCPMOmni.load_vision("./model/siglip2-base-p32-256-ve")
...
def main():
    parser = argparse.ArgumentParser(description="PigCPM-O Chat")
