...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_project", type=str, default="PigCPM-O", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"PigCPM-O-{time.strftime('%Y%m%d-%H%M%S', time.gmtime(time.time() + 8 * 3600))}"
