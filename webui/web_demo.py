...
from model.model_omni import PigCPMOmni, RealtimeSession
...
def load_main_model(model_path, model_name):
    with MODEL_LOCK:
        ...
        vision_encoder, vision_processor = PigCPMOmni.load_vision('../model/siglip2-base-p32-256-ve')
        audio_encoder, audio_processor = PigCPMOmni.load_sensevoice('../model/SenseVoiceSmall')
